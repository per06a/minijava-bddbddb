...
/**
 * Grammar production: f0 -> "if" f1 -> "(" f2 -> Expression() f3 -> ")" f4 ->
 * Statement() f5 -> "else" f6 -> Statement()
 */
public class IfStatement implements Node {
	/**
	 * 
	 */
	private static final long serialVersionUID = -324087192782026777L;
	...
	public IfStatement(NodeToken n0, NodeToken n1, Expression n2, NodeToken n3,
			Statement n4, NodeToken n5, Statement n6) {
		f0 = n0;
		f1 = n1;
		f2 = n2;
		f3 = n3;
