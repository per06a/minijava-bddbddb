...
public class MiniJavaParser implements MiniJavaParserConstants {
		...
		n29 = JTBToolkit.makeNodeToken(n30);
		{
			if (true)
				return new MainClass(n0, n2, n3, n5, n7, n9, n11, n13, n15,
						n17, n19, n21, n22, n24, n26, n27, n29);
		}
		throw new Error("Missing return statement in function");
	}
	...
	static final public ClassDeclaration ClassDeclaration()
	...
	static final public ClassExtendsDeclaration ClassExtendsDeclaration()
			throws ParseException {
		NodeToken n0;
		Token n1;
		Identifier n2;
		...
		{
			if (true)
				return new ClassExtendsDeclaration(n0, n2, n3, n5, n6, n8, n10,
						n12);
		}
		throw new Error("Missing return statement in function");
	}
	...
	static final public MethodDeclaration MethodDeclaration()
			throws ParseException {
		NodeToken n0;
		Token n1;
		Type n2;
	...
	static final public FormalParameterList FormalParameterList()
			throws ParseException {
		FormalParameter n0;
		NodeListOptional n1 = new NodeListOptional();
	...
	static final public FormalParameterRest FormalParameterRest()
			throws ParseException {
		NodeToken n0;
		Token n1;
		FormalParameter n2;
	...
	static final public AssignmentStatement AssignmentStatement()
			throws ParseException {
		Identifier n0;
		NodeToken n1;
		Token n2;
	...
	static final public ArrayAssignmentStatement ArrayAssignmentStatement()
			throws ParseException {
		Identifier n0;
		NodeToken n1;
		Token n2;
	...
	static final public CompareExpression CompareExpression()
			throws ParseException {
		PrimaryExpression n0;
		NodeToken n1;
		Token n2;
	...
	static final public PrimaryExpression PrimaryExpression()
			throws ParseException {
		NodeChoice n0;
		IntegerLiteral n1;
		TrueLiteral n2;
	...
	static final public ArrayAllocationExpression ArrayAllocationExpression()
			throws ParseException {
		NodeToken n0;
		Token n1;
		NodeToken n2;
	...
	static final public AllocationExpression AllocationExpression()
			throws ParseException {
		NodeToken n0;
		Token n1;
		Identifier n2;
	...
	static final public BracketExpression BracketExpression()
			throws ParseException {
		NodeToken n0;
		Token n1;
		Expression n2;
	...
	static final private Token jj_consume_token(int kind) throws ParseException {
		...
		if ((oldToken = token).next != null)
			...
			token = token.next = MiniJavaParserTokenManager.getNextToken();
		jj_ntk = -1;
		if (token.kind == kind) {
			jj_gen++;
			if (++jj_gc > 100) {
	...
	static private final class LookaheadSuccess extends java.lang.Error {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -1346286113457548779L;
	}
	...
	static final private boolean jj_scan_token(int kind) {
		if (jj_scanpos == jj_lastpos) {
			...
			if (jj_scanpos.next == null) {
				jj_lastpos = jj_scanpos = jj_scanpos.next = MiniJavaParserTokenManager
						.getNextToken();
			} else {
	...
	static final public Token getToken(int index) {
		...
		for (int i = 0; i < index; i++) {
			if (t.next != null)
				...
				t = t.next = MiniJavaParserTokenManager.getNextToken();
		}
		return t;
	}
	...
	static final private int jj_ntk() {
		if ((jj_nt = token.next) == null)
			return (jj_ntk = (token.next = MiniJavaParserTokenManager
					.getNextToken()).kind);
		else
